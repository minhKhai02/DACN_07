...
class MainActivity : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appLaunched(com.simplemobiletools.calendar.pro.BuildConfig.APPLICATION_ID)
        setupOptionsMenu()
        refreshMenuItems()
    ...
    private fun launchAbout() {
        ...
        startAboutActivity(R.string.app_name, licenses, com.simplemobiletools.calendar.pro.BuildConfig.VERSION_NAME, faqItems, true)
    }
    ...
    private fun checkWhatsNewDialog() {
        arrayListOf<Release>().apply {
            ...
            checkWhatsNew(this, com.simplemobiletools.calendar.pro.BuildConfig.VERSION_CODE)
        }
    }
}
